...
import { Plus, Search, Briefcase, Calendar, Award, X, RefreshCw, Trash2, AlertTriangle, Edit, Shield, User as UserIcon, Ban } from 'lucide-react';
  ...
  const handleEditEmployee = async (employee: Employee) => {
    try {
      ...
      try {
        ...
        console.error('Failed to fetch skills for edit:', e);
      }
    ...
    <div className="h-full flex flex-col"> 
      ...
      <div className="flex-shrink-0 mb-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className={`text-3xl font-bold ${darkMode ? 'text-gray-100' : 'text-gray-900'}`}>Employee Management</h1>
            <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'} mt-1`}>
              {totalElements > 0 ? `Total: ${totalElements} ${activeTab.toLowerCase()}s` : 'Manage your team members and roles'}
            </p>
          </div>
      ...
      {/* Tabs */}
      <div className="flex-shrink-0 flex border-b mb-6 dark:border-gray-700">
        <button
          onClick={() => {
            setActiveTab('EMPLOYEE');
            setCurrentPage(0);
              ...
              <div>
                ...
                <div className="relative" ref={userDropdownRef}>
                  ...
                  <button
                    ...
                    } ${showUserDropdown ? (darkMode ? 'ring-2 ring-indigo-500 border-indigo-500' : 'ring-2 ring-indigo-500 border-indigo-500') : ''}`}
                  >
                    {formData.userId ? (
                      <div className="flex items-center gap-2">
                            ...
                            <div
                              ...
                              className={`flex items-center gap-3 px-3 py-2.5 cursor-pointer transition ${
                                formData.userId === u.id
                                  ? (darkMode ? 'bg-indigo-900/40 border-l-2 border-indigo-500' : 'bg-indigo-50 border-l-2 border-indigo-500')
