...
export const authAPI = {
   ...
   */
  registerCompany: (data: Record<string, any>) =>
...
export const tasksAPI = {
   ...
   */
  requestTask: (data: Record<string, unknown>) =>
...
export const chatAPI = {
  ...
  getDirectMessages: (otherUserId: string) =>
...
export const aiAPI = {
   ...
   */
  getAssignmentSuggestions: (data: Record<string, unknown>) =>
   ...
   */
  predictDuration: (data: Record<string, unknown>) =>
   ...
   */
  getEmployeeSkillsBatch: (employeeIds: string[]) => {
    const params = new URLSearchParams();
   ...
   */
  getTaskSkillsBatch: (taskIds: string[]) => {
    const params = new URLSearchParams();
   ...
   */
  detectAnomalies: (data: Record<string, unknown>, bustCache: boolean = false) => {
   ...
   */
  getProductivityAnalytics: (timePeriodDays: number = 30, bustCache: boolean = false) => {
   ...
   */
  bulkOptimize: (data: Record<string, unknown>) =>
  ...
  bulkOptimizeBalanced: (taskIds: string[], token: string, companyId: string) =>
  ...
  triggerRetraining: (fullRetrain: boolean = false) =>
  ...
  extractSkillsFromText: (data: Record<string, unknown>) =>
  ...
  analyzeTaskComplexity: (data: Record<string, unknown>) =>
  ...
  suggestTeamSkills: (data: Record<string, unknown>) =>
  ...
  batchExtractSkills: (tasks: Record<string, unknown>[]) =>
...
export const chatbotAPI = {
  ...
  pullModel: (modelName: string = "phi3") =>
