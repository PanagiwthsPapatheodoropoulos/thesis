...
import type { SkillsMultiSelectProps } from '../types';
      ...
      <div className="relative">
        <input
          ...
          className={`w-full px-3 py-2 border rounded-lg outline-none transition-all duration-200 ${
            darkMode
              ? 'bg-gray-700 border-gray-600 text-gray-100 placeholder-gray-400 hover:border-gray-500 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/15'
              : 'bg-white border-gray-300 text-gray-900 placeholder-gray-550 hover:border-gray-400 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10'
          }`}
        />
