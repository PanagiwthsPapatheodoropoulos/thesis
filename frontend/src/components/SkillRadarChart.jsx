 ...
 */
const SkillRadarChart = ({ skills, darkMode = false, title = "Skill Proficiency" }) => {
  ...
  useEffect(() => {
    ...
    const skillNames = allSkills.map(s => s.skillName || s.name || 'Unknown');
    const proficiencies = allSkills.map(s => {
        ...
        plugins: {
          ...
          tooltip: {
            ...
            callbacks: {
              ...
              label: (context) => `Level: ${context.parsed.r}/5`
            }
          }
        },
        elements: {
