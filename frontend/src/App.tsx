...
const ConditionalChatbot: React.FC = () => {
  ...
  // Don't show chatbot if user is not authenticated, on super admin page, or for SUPER_ADMIN role users
  const hideChatbot = !user || location.pathname === '/super-admin' || user?.role === 'SUPER_ADMIN';
