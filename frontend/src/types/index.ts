...
/** Roles with managerial administrative privileges. */
export type ManagerialRole = 'SUPER_ADMIN' | 'ADMIN' | 'MANAGER';

/** Standard callback taking no arguments and returning void. */
export type VoidCallback = () => void;

/** Tabs in the Task Detail view modal. */
export type TaskDetailTab = 'details' | 'comments' | 'history' | 'time';
