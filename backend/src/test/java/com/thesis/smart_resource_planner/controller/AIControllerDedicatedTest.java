...
class AIControllerDedicatedTest {
    ...
    void getProductivityAnalytics_success() {
        ...
        var res = controller.getProductivityAnalytics(Map.of("time_period_days", 7, "bust_cache", true), principal, null,
                "Bearer t");
    ...
    void getAssignmentSuggestions_missingCompany_returns400() {
        ...
        var res = controller.getAssignmentSuggestions(Map.of("taskId", UUID.randomUUID().toString()), p, null, "Bearer t");
    ...
    void predictTaskDuration_serviceError_returnsOkWithError() {
        when(aiService.predictTaskDuration(anyString(), anyString(), anyString(), anyDouble(), anyList(), any(), anyString(), any(UUID.class)))
    ...
    void detectAnomalies_nullResult_returnsDefaultPayload() {
        ...
        var res = controller.detectAnomalies(Map.of("entityType", "TASK", "entityId", "all"), principal, null, "Bearer t");
        assertEquals(200, res.getStatusCode().value());
    ...
    void extractSkills_error_returns500() {
        ...
        var res = controller.extractSkills(Map.of("text", "java spring"), principal, null, "Bearer t");
    ...
    void pullModel_error_returns500() {
        ...
        var res = controller.pullModel("phi3", principal, null, "Bearer t");
        assertEquals(500, res.getStatusCode().value());
    ...
    void analyzeTaskComplexity_success_returnsForwardedBody() {
        ...
        var res = controller.analyzeTaskComplexity(Map.of("title", "task"), principal, null, "Bearer t");
        assertEquals(200, res.getStatusCode().value());
    ...
    void chatWithAI_success_injectsRoleContext() {
        ...
        var res = controller.chatWithAI(Map.of("query", "hello"), principal, null, "Bearer t");
        assertEquals(200, res.getStatusCode().value());
    ...
    void getProductivityAnalytics_defaultsWhenRequestNull() {
        ...
        var res = controller.getProductivityAnalytics(null, principal, null, "Bearer t");
        assertEquals(200, res.getStatusCode().value());
    ...
    void triggerRetraining_success() {
        ...
        var res = controller.triggerRetraining(true, principal, null, "Bearer t");
        assertEquals(200, res.getStatusCode().value());
    ...
    void triggerRetraining_error_returnsOkWithError() {
        ...
        var res = controller.triggerRetraining(false, principal, null, "Bearer t");
        assertEquals(200, res.getStatusCode().value());
    ...
    void detectAnomalies_error_returnsOkWithError() {
        ...
        var res = controller.detectAnomalies(Map.of("entityType", "TASK", "entityId", "id1"), principal, null, "Bearer t");
        assertEquals(200, res.getStatusCode().value());
    ...
    void getAssignmentSuggestions_serviceError_returnsEmptySuggestions() {
        ...
        void prioritizeBacklog_success_returnsBody() {
                ...
                var res = controller.prioritizeBacklog(tasks, principal, null, "Bearer t");
        ...
        void prioritizeBacklog_nullResult_returnsDefaultPayload() {
                ...
                var res = controller.prioritizeBacklog(List.of(), principal, null, "Bearer t");
                assertEquals(200, res.getStatusCode().value());
        ...
        void suggestTeamSkills_success_returnsBody() {
                ...
                var res = controller.suggestTeamSkills(Map.of("team_tasks", List.of()), principal, null, "Bearer t");
