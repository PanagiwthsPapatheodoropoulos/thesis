...
class TaskControllerDedicatedTest {
    ...
    void setup() {
        ...
        u.setStatus(com.thesis.smart_resource_planner.model.enums.UserStatus.ONLINE);
    ...
    void requestApproveRejectStatus_paths() throws Exception {
        ...
        employeeUser.setStatus(com.thesis.smart_resource_planner.model.enums.UserStatus.ONLINE);
