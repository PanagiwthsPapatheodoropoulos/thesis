...
class AIServiceDedicatedTest {
    ...
    void predictTaskDuration_successAndException() {
        ...
        Map<String, Object> ok = aiService.predictTaskDuration(taskId.toString(), "Desc", "MEDIUM", 0.5, List.of(), null, "token", companyId);
        assertNotNull(ok);
        ...
        Map<String, Object> bad = aiService.predictTaskDuration(taskId.toString(), "Desc", "MEDIUM", 0.5, List.of(), null, "token", companyId);
        assertNull(bad);
    }
