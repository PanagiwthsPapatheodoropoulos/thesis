...
class AuthServiceDedicatedTest {
    ...
    @Test
    @DisplayName("logout updates user status to OFFLINE and broadcasts presence")
    void logout_updatesStatusAndBroadcasts() {
        User user = new User();
        ...
        assertEquals(com.thesis.smart_resource_planner.model.enums.UserStatus.OFFLINE, user.getStatus());
        verify(userRepository).save(user);
        verify(webSocketBroadcastService).broadcastUserPresence(user.getId(), com.thesis.smart_resource_planner.model.enums.UserStatus.OFFLINE);
    }
}
