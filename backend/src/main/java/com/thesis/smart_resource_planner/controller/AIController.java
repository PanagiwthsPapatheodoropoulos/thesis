...
public class AIController {
    ...
    public ResponseEntity<Map<String, Object>> getAssignmentSuggestions(
        ...
        try {
            ...
            String token = (jwtCookie != null && !jwtCookie.isEmpty()) ? jwtCookie : (authHeader != null && authHeader.startsWith("Bearer ") ? authHeader.substring(7) : "");
    ...
    public ResponseEntity<Map<String, Object>> predictTaskDuration(
        ...
        try {
            ...
            String assignedEmployeeId = (String) request.get("assignedEmployeeId");
