...
public class UserController {
     ...
     */
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER', 'EMPLOYEE') or #id == authentication.principal.id")
    ...
    public ResponseEntity<Void> updateUserStatus(@PathVariable UUID id, @RequestBody Map<String, String> body) {
    ...
    public ResponseEntity<UserDTO> updateUsername(
        ...
        String jwt = tokenProvider.generateTokenFromUsername(updated.getUsername());
