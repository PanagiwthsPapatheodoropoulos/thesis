    ...
    public void deleteCompany(UUID companyId) {
        ...
        try {
            ...
            for (Task task : tasks) {
                ...
                try {
                    List<com.thesis.smart_resource_planner.model.entity.TaskComment> comments = taskCommentRepository.findByTaskIdOrderByCreatedAtDesc(taskId);
                ...
                try {
                    List<com.thesis.smart_resource_planner.model.entity.TaskAuditLog> auditLogs = taskAuditLogRepository.findByTaskIdOrderByCreatedAtDesc(taskId);
                ...
                try {
                    List<com.thesis.smart_resource_planner.model.entity.TaskTimeEntry> timeEntries = taskTimeEntryRepository.findByTaskIdOrderByWorkDateDesc(taskId);
