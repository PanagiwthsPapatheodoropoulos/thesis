...
public class WebSocketBroadcastService {
    ...
    /**
     * Broadcasts a user's presence status change globally so clients can update UI.
     *
     * @param userId the UUID of the user
     * @param status the new UserStatus
     */
    public void broadcastUserPresence(UUID userId, UserStatus status) {
        try {
            ...
            log.error("Failed to broadcast presence for {}: {}", userId, e.getMessage());
        }
    }
